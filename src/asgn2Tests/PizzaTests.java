...
public class PizzaTests {
	// check exception when quantity too low
	...
	// check exception when quantity too high
	@Test (expected=PizzaException.class)
	...
	// check exception order time is too early 
	@Test (expected=PizzaException.class)
	...
	// check exception order time is too late 
	@Test (expected=PizzaException.class)
	...
	// check exception when pizza too old 
	@Test (expected=PizzaException.class)
	...
	// Check if the cost of pizzas are being return correctly 
	@Test 
	...
	@Test// Check if the pizza prices are correct  
	...
	// Check if the pizza prices are correct 
	@Test 
	...
	// Check if the pizza orders type are correct 
	@Test 
